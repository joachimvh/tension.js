...
const check: BuiltinCheckFn = ({ quad }: BuiltinCallOptions): boolean | undefined => {
  if (quad.subject.termType === 'BlankNode' || quad.object.termType === 'BlankNode') {
    return quad.subject.termType === quad.object.termType && quad.subject.value === quad.object.value ? false : undefined;
  }
...
export default {
  predicate: 'http://www.w3.org/2000/10/swap/log#notEqualTo',
  check,
